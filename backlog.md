...
### Match Filtering & Grouping
The fixture list shows all 104 matches flat. Group and filter them.

- Group stage: Group A–L sections with header rows
- Knockout rounds: Round of 32, Round of 16, Quarter-Finals, Semi-Finals, Final
- Status filter: All / Scheduled / Live / Completed
- Pure UI change — no backend work needed

### Optimistic Tip Submission
...
### `insights.repository` Unit Tests
...
### E2E Coverage for Seeded-DB Flows
