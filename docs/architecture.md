...
| **Test coverage** | 61 unit tests across all repositories; E2E suite covers all routes including competition-scoped fixtures, leaderboard, leagues, admin, profile, cron |
